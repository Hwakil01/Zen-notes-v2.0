...
- 💬 Real-time notes display with animation
- 🔎 Search through notes
- 👁️ "Show more / Show less" toggle
- 🔄 Rolling ZenChain logo animation
- 📱 Fully responsive across all screen sizes
- 🎨 Smooth gradient background + modern UI
- 🧭 Sticky top menu with dropdown (About ZenChain, Contact Developer)
...
**Hassan Ali Wakili**  
🧑‍💻 GitHub: [@hwakil01](https://github.com/hwakil01)  
🐦 Twitter: [@WorldNoobG72516](https://x.com/WorldNoobG72516)
